...
class EditImageRepoClass(private val context: Context) : EditImageRepo{
    ...
    private fun saveFile(file: File, filteredBitmap: Bitmap){
        with(FileOutputStream(file)){
            filteredBitmap.compress(Bitmap.CompressFormat.JPEG,100,this)
        }
    }
